...
public class ConsultationMapper
{
    ...
    public async Task<ConsultationResponse> UpdateAsync(Guid id, DateTime startTime, DateTime endTime, Guid roomId)
    {
        var result = await _consultationService.UpdateAsync(id, startTime, endTime, roomId);
        return result.ToResponse();
    }
